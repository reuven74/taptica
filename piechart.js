     ...
     google.setOnLoadCallback(drawTable);
      ...
      function drawTable() {
	   ...
	   $.each( publishersData, function( key, value ) { 
	    buf = Array();
	    buf.push(publishersData[key][0]);
		buf.push(publishersData[key][1]);
		buf.push(publishersData[key][2]);
		buf.push("");
		buf.push(publishersData[key][4]);
		buf.push(publishersData[key][5]);
		buf.push(publishersData[key][6]);
		buf.push("");
		buf.push("");
		buf.push(publishersData[key][9]);
		buf.push(publishersData[key][10]);
		var buff = Array();
		buff.push(buf);
        data.addRows(buff);	   
	   });
